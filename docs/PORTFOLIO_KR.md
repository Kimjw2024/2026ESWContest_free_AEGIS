...
이 저장소는 [원본 공동 프로젝트 저장소](https://github.com/tigerjueun/2026ESWContest_free_AEGIS)를 기반으로 한 개인 GitHub 포트폴리오용 private mirror입니다. 원본 저장소의 소유권이나 팀 전체의 기여를 대체하지 않습니다.
...
이 mirror의 목적은 공동 프로젝트를 개인 포트폴리오에서 설명하기 쉽게 정리하는 것입니다. 원본 저장소의 README, 팀 역할 문서, 기술 문서와 결과표를 함께 확인하면 구현 범위와 기여 경계를 정확히 이해할 수 있습니다.
